...
import { Calendar, MapPin, Mountain, Timer } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-white font-semibold">View Race Details</span>
        </motion.div>
      </motion.div>
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          >
            <h3 className="text-xl font-semibold text-white">{distance}</h3>
